  ...
  return (
    <div id="social" className='footer' style={{ backgroundImage: `url(${y})` }}>
      <div className="socials">
        <div className="git" id='soc'><a href="https://github.com/R3tr0LastKnight" target="blank"><img src={git} alt="" /></a></div>
        <div className="linked" id='soc'><a href="https://www.linkedin.com/in/shubh-shahu/" target="blank"><img src={link} alt="" /></a></div>
