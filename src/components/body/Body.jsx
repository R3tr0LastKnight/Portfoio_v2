    ...
    <div className="all mt-16">
      ...
      <div className="h-[69vh] relative">
        <ScrambleAnimation
          ...
          pauseDuration={2000}
          start={true}
          className="pointer-events-none z-10 absolute w-full flex justify-center top-24  !text-white !text-base lg:!text-5xl font-bold leading-none tracking-tighter font-Major "
        />
