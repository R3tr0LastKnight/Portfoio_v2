...
const baroqueWorks = [
  ...
  ,
  {
    ...
    name: "Calculator",
    disc:
      "Just a simple calculator web-app which performs arithematic operations such as addition subtraction multiplication and division. nothing much fancy but gets its job done.",
  ...
  },
  {
    ...
    disc:
      "This is a bootstrap project about a website the shocases candies placed in my Museum.",
